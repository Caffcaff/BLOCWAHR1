...
//					}
//
//					if (distance > (chaseAttackRange * 1.5)) {
//						target = null;
//					}
//
//
...
//								tempRocket.GetComponent<missileLogic> ().owner = this.gameObject;
//								tempRocket.GetComponent<missileLogic> ().target = target;
//								reload = fireRate;
//							}
//						}
//					}
...
//										GameObject tempTracer = Instantiate (ammoType, launcher.transform.position, launcher.transform.rotation);
//										tempTracer.GetComponent<tracerLogic> ().owner = this.gameObject;
//										reload = fireRate;
//									}
//								} else {
...
//
//			if (cMemory != null) {
//				eventManager.ReturnOrder (cMemory, null, 2);
//			}
//
...
//
//				if (_state != State.Attack) {
//					if (sender.tag == ("Friendly")) {
//						if (sender.GetComponent<unitAgent> ().playerID != playerID) {
//							enemyEncounter (sender);
//						}
//					}
//					if (sender.tag == ("Structure")) {
//						if (sender.GetComponent<buildLogic> ().playerID != playerID) {
//							structEncounter (sender);
//						}
//					}
//						
//				}
...
//		}
//
//		void AIencounter(Collider other){
//
//			if (_logicState != logicState.Attack) {
//
...
//				if (unit.tag == ("tracer")) {
//
//					tracerLogic logic = unit.GetComponent<tracerLogic> ();
//
//					if (logic.owner != null) {
//						if (logic.owner.GetComponent<unitAgent> ().playerID != playerID) {
//							enemyEncounter (logic.owner);
//						}
//					}
//						
//				}
...
//				if (unit.tag == ("missile")) {
//
//					missileLogic logic = unit.GetComponent<missileLogic> ();
//
//					if (logic.owner != null) {
//						if (logic.owner.GetComponent<unitAgent> ().playerID != playerID) {
//							enemyEncounter (logic.owner);
...
//
//					if (unit.GetComponent<unitAgent> ().playerID != playerID) {
//						enemyEncounter (unit);
//					}	
//
//				}
...
//
//			navMemory now = navScan ();
//			eventManager.StructEncounter (now, playerID);
//
//			if (_type == Type.Miner || _type == Type.Utility) {
//				flee ();
//			} else {
...
//			if (findRefinery () != null) {
//				
//				navTarget = findRefinery ().transform.position;
//				_state = State.Flee;
//				_logicState = logicState.Move;
//			} 
//			else {
