...
//	void Start () {
//		if (GetComponent<AICommand> () != null) {
//			playerID = GetComponent<AICommand> ().playerID;
//			AIplayer = true;
//		}else{
//			playerID = GetComponent<playerCommand> ().playerID;
//			AIplayer = false;
//		}
//
//		if (sManager == null && AIplayer == false) {
...
//	void navArray (Vector3 hit, GameObject unit, int ID) {
//
//		if (ID == playerID) {
//
//			currArray.Clear ();
...
//			GameObject[] currSelect = new GameObject[2];
//
//			if (AIplayer == true) {
//				currSelect = GetComponent<AIunitController> ().currSelect;
//			} else {
//				currSelect = sManager.currentSelection.ToArray();
//			}
//
...
//
//
//			foreach (GameObject part in currSelect) {
//				if (i > 0 && r < columns) {
//					eventManager.ParticleEvent (hit, hit, 3);
//					eventManager.NavArray (hit, part, false, playerID);
...
//				if (i == 0) {
//					eventManager.ParticleEvent (hit, hit, 3);
//					eventManager.NavArray (hit, part, true, playerID);
//
//					if ((columns % 2) > 0) {
...
//		}
//	}
//	void surroundObject(Vector3 point, GameObject target, int ID){
//
//		if (ID == playerID) {
//
//			int r = 0;
...
//					if (i == 0) {
//						eventManager.AttackArray (hit, part, true, playerID);
//						i++;
//					}
//					if (i != 0) {
//						eventManager.AttackArray (hit, part, false, playerID);
//					}
//
//					eventManager.ParticleEvent (hit, hit, 3);
//
...
//
//	void stackFormation(Vector3 hit, GameObject leader, bool unused, int ID){
//
//		if (ID == playerID) {
//
//			GameObject[] currSelect = new GameObject[2];
...
//			}
//
//			foreach (GameObject unit in currSelect) {
...
//	}
//
////	void orderSwitch(Order order, GameObject unit, int status){
////
////		if (order.playerID == playerID) {
////
////			if (order._type == Order.Type.Move || order._type == Order.Type.Recon) {
////
////				navArray(order.navTarget, unit, order.playerID);
////			}
////			if (order._type != Order.Type.Move && order._type != Order.Type.Patrol && order._type != Order.Type.Recon) {
////
////				surroundObject(order.navTarget, unit, order.unitTarget, order.playerID);
////
////			}
////
////		}
